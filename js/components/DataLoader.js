  ...
  "categories": [
    {
      ...
      "prompts": [
        ...
        },
        {
          ...
          "difficulty": "intermediate",
          "prompt": {
            "positive": "{\n  \"portrait_prompt\": {\n    \"subject\": \"一位年轻亚洲女性的特写，她留着刘海，身穿红色细肩带连衣裙。她微微仰头，下巴高高抬起，慵懒放松地露出优雅的颈部。一只手正轻轻将一颗小红樱桃番茄按在她的锁骨区域。背景中可见红色丝带。\",\n    \"composition\": \"极致特写，从胸部下方拍摄，对角线向上取景。浅景深（约f/2.0）虚化背景，同时保持面部、颈部与肩膀的清晰对焦。50mm镜头。\",\n    \"camera_angle\": \"从胸部下方低角度，对角向上拍摄，营造亲密与高挑感。\",\n    \"lighting\": \"强烈的自然逆光来自上方窗户或天窗。高调照明配合柔和梦幻的光晕（光渗）效果。光线环绕她的侧脸，形成发光轮廓光。\",\n    \"color_palette\": \"温暖复古胶卷美学。主色为鲜艳红色与温暖奶油肤色。略微过曝的高光带来怀旧夏日氛围，类似Kodak Portra 400胶卷，带胶片颗粒。\",\n    \"mood\": \"亲密、感性、氛围感、梦幻，日系写真风格，捕捉夏日炽热与放松的稍纵即逝瞬间。\",\n    \"negative_prompt\": \"不真实的特征、解剖错误、僵硬姿势、生硬阴影、冷色调、低分辨率、构图差、手部变形、多余手指、水印、文字、黑暗环境\"\n  }\n}"
          },
          "images": {
        ...
        },
        {
          ...
          "difficulty": "intermediate",
          "prompt": {
            "positive": "电影感的米兰奢侈品区夜景，现代建筑与时装屋林立。整栋建筑的LED广告牌展示着同一位女性的高定系列肖像，戏剧性阴影，编辑式灯光。广告牌上用奢华字体写着\"MAESTRIA\"。前景中，她自信地站立，身着雕塑感黑色礼服，大理石地面反射着温暖灯光，豪华汽车驶过，情绪色调，高级时尚广告风格，超现实主义，1:1，8K。"
          },
          "images": {
            "thumbnail": "images/prompt/13.webp",
            "full": "images/prompt/13.webp"
          }
        },
        {
          "id": "14",
          "title": "纯白九宫格湿发超模",
          "description": "几缕湿发轻贴脸颊与下颌线",
          "tags": [
            "人像",
            "中级",
            "光线",
          ...
          "difficulty": "intermediate",
          "prompt": {
            "positive": "{\n  \"type\": \"图生图\",\n  \"model\": \"stable-diffusion-xl\",\n  \"prompt\": \"保持相同面孔与身份。垂直高端时尚美妆拼贴，以3×3网格排列的特写肖像，置于干净无接缝的纯白工作室背景。明亮均匀的正向工作室照明配柔和补光，消除刺眼阴影并营造光泽 editorial 造型。颧骨、鼻梁、嘴唇以及白色T恤领口处带微妙高光，背景始终保持均匀纯白。年轻女性从颈部中段以上取景，双肩端正、每格均正对镜头。长而松散湿润的头发自然垂落肩头，部分覆于面部，几缕湿发轻贴脸颊与下颌线，一些垂向嘴唇，增添动感与原始随性的美感。湿发质感带柔和光泽反射光线，光泽与自然不完美形成对比。整个网格中她大幅度变换面部表情；其中一个表情包括伸舌头。\",\n  \"negative_prompt\": \"低分辨率、模糊、刺眼阴影、不均匀照明、色偏、背景纹理、多余肢体、面部扭曲、过曝高光、欠曝区域\",\n  \"aspect_ratio\": \"2:3\",\n  \"style\": \"高端时尚 editorial\",\n  \"lighting\": \"明亮均匀工作室照明、柔和补光\",\n  \"background\": \"纯白无接缝工作室\",\n  \"output\": {\n    \"grid\": \"3x3\",\n    \"orientation\": \"垂直\",\n    \"framing\": \"颈部中段以上\"\n  }\n}"
          },
          "images": {
        ...
        },
        {
          ...
          "difficulty": "intermediate",
          "prompt": {
            "positive": "输入 A 是一个数学符号、字母或常数（例如 Pi、Sigma、Infinity、Delta）。  \n生成 4 种不同的烹饪介质来呈现该符号：  \n介质 1（液体）：一种粘稠的酱汁或蘸料（例如红色 Salsa、Pesto、融化巧克力）。  \n介质 2（颗粒）：一种谷物或组合单元（例如寿司米饭、玉米粒、咖啡豆）。  \n介质 3（固体）：一种烘焙或烹饪结构（例如披萨饼皮、椒盐卷饼面团、烤肉）。  \n介质 4（粉末）：一种鲜艳的香料或粉末（例如姜黄、面粉、抹茶粉）。  \n\n2. 容器  \n目标：“可食用字体”食物摄影。  \n格式：2x2 网格构图。  \n画布：每个面板展示一块带纹理的黑色岩板餐盘，置于质朴的木桌上。  \n主体：符号（输入 A）用该面板指定的介质在岩板中央塑形。  \n\n3. 构图（摆盘）：  \n面板 1（液体/凌乱）：用酱汁绘制符号。周围摆放蘸食小食（薯片、面包）与点缀（奶酪碎、香草）。  \n面板 2（颗粒/精确）：用紧密排列的谷物或寿司卷拼成符号。周围放置工具（筷子、勺子）。  \n面板 3（固体/结构）：符号被烘焙或雕刻，具有高度与 3D 体积。表面装饰配料（橄榄、意大利辣肠）。  \n面板 4（粉末/地形）：符号以负形或堆叠香料脊线呈现。  \n微细节：1:87 比例小工人/矿工人偶与粉末互动，将其当作景观（铲姜黄、铺设轨道）。  \n\n4. 语法（激发食欲）：  \n色彩：高饱和度。食物颜色（红色酱汁、黄色香料、白色米饭）必须在黑色石板上突出。  \n质感：酱汁可见水分，面包可见碎屑，香料可见颗粒。  \n\n输出：单张图像，1:1 宽高比，2x2 网格，食物摄影，“平铺”美学，高质感。"
          },
          "images": {
            "thumbnail": "images/prompt/22.webp",
            "full": "images/prompt/22.webp"
          }
        },
        {
          "id": "23",
          "title": "萌宠零食派对",
          "description": "照片级真实结合风格化真实感",
          "tags": [
            "人像",
            "中级",
            "近景",
          ...
          "difficulty": "intermediate",
          "prompt": {
            "positive": "{\n  \"global_settings\": {\n    \"resolution\": \"8K超高清\",\n    \"aspect_ratio\": \"3:4竖幅\",\n    \"image_quality\": \"极致细节，超锐焦点\",\n    \"lighting_style\": \"温暖电影光效配金色散景背景\",\n    \"depth_of_field\": \"浅景深，主体强烈分离\",\n    \"render_style\": \"AI精修，超写实，照片级真实结合风格化真实感\",\n    \"color_grading\": \"暖色调，金色高光，柔和阴影\",\n    \"background\": \"失焦的金色圆形散景光点\"\n  },\n  \"Module_1_Image_1_Style\": {\n    \"subject\": \"猫咪形状玉米片\",\n    \"primary_container\": {\n      \"type\": \"红色纸制零食袋\",\n      \"design\": \"正面大幅卡通猫插画\",\n      \"graphics\": \"简约面部特征，柔和粉彩色调\",\n      \"material\": \"哑光纸质纹理\"\n    },\n    \"chip_details\": {\n      \"shape\": \"带尖耳的猫头\",\n      \"color\": \"金橙色油炸质感\",\n      \"surface\": \"酥脆起泡，略不平整\",\n      \"facial_features\": {\n        \"eyes\": \"小黑圆点\",\n        \"mouth\": \"简单弧线\",\n        \"whiskers\": \"细暗线\"\n      }\n    },\n    \"poses_and_interactions\": {\n      \"one_chip\": \"手持三角奶酪片\",\n      \"foreground_chips\": \"放在袋外表面\"\n    },\n    \"composition\": {\n      \"camera_angle\": \"略高于视线\",\n      \"framing\": \"紧凑竖幅构图\",\n      \"focus\": \"玉米片锐利，背景虚化\"\n    }\n  },\n  \"Module_2_Image_2_Style\": {\n    \"subject\": \"绵羊形状爆米花人偶\",\n    \"primary_container\": {\n      \"type\": \"经典爆米花桶\",\n      \"design\": \"红白竖条纹\",\n      \"material\": \"纸板配柔和哑光表面\"\n    },\n    \"sheep_details\": {\n      \"body\": \"全由玉米粒构成\",\n      \"head\": \"光滑白色圆脸\",\n      \"ears\": \"小圆耳，内耳淡黄\",\n      \"eyes\": \"极小黑点\",\n      \"mouth\": \"细弯微笑线\"\n    },\n    \"poses_and_accessories\": {\n      \"one_sheep\": \"握黑色电视遥控器\",\n      \"multiple_sheep\": \"从爆米花堆后探头\"\n    },\n    \"composition\": {\n      \"layering\": \"绵羊层叠聚集\",\n      \"foreground\": \"底部散落额外爆米花\",\n      \"focus\": \"中央绵羊锐利对焦\"\n    }\n  },\n  \"Module_3_Image_3_Style\": {\n    \"subject\": \"熊形状炸鸡爆米花块\",\n    \"primary_container\": {\n      \"type\": \"白色爆米花桶\",\n      \"branding\": \"文字为'Chicken Popcorn'\",\n      \"graphics\": \"文字上方简约厨师帽图标\",\n      \"decoration\": \"小彩色波点\"\n    },\n    \"nugget_details\": {\n      \"shape\": \"泰迪熊剪影\",\n      \"color\": \"金棕油炸外壳\",\n      \"texture\": \"酥脆裹粉表面\",\n      \"facial_features\": {\n        \"eyes\": \"小黑珠\",\n        \"nose\": \"圆黑鼻头\",\n        \"mouth\": \"极小暗线\"\n      }\n    },\n    \"poses_and_accessories\": {\n      \"one_nugget\": \"握苏打杯配吸管\",\n      \"foreground_nuggets\": \"立于桶外\"\n    },\n    \"composition\": {\n      \"camera_distance\": \"中近景\",\n      \"bucket_position\": \"垂直居中\",\n      \"lighting\": \"暖高光突出质感\"\n    }\n  }\n}"
          },
          "images": {
            "thumbnail": "images/prompt/23.webp",
            "full": "images/prompt/23.webp"
          }
        },
        {
          "id": "24",
          ...
          "difficulty": "intermediate",
          "prompt": {
            "positive": "\"atmosphere\": {\n      \"mood\": \"俏皮且欢乐\",\n      \"mist\": \"柔和薄雾\",\n      \"lighting\": \"柔和粉彩照明\"\n    }\n  },\n  \"river\": {\n    \"type\": \"融化的焦糖与巧克力\",\n    \"motion\": \"如糖浆般轻柔旋转\",\n    \"texture\": \"光滑、光亮、流动\"\n  },\n  \"boats\": {\n    \"style\": \"乐高风格\",\n    \"materials\": [\"威化饼\", \"巧克力\"],\n    \"details\": {\n      \"toppings\": [\"彩色糖针\", \"棉花糖\"],\n      \"scale\": \"玩具比例\"\n    },\n    \"movement\": \"顺流漂浮\"\n  },\n  \"characters\": {\n    \"type\": \"乐高角色\",\n    \"actions\": [\n      \"欢快地划糖果船\",\n      \"将手浸入焦糖和巧克力河流\"\n    ],\n    \"expressions\": \"快乐且俏皮\"\n  },\n  \"background\": {\n    \"landscape_elements\": [\n      \"棉花糖山丘\",\n      \"软糖树\",\n      \"糖果桥\"\n    ],\n    \"connections\": \"连接糖果景观各部分的桥梁\"\n  },\n  \"style\": {\n    \"visual_style\": \"俏皮卡通3D\",\n    \"color_palette\": \"柔和粉彩色\",\n    \"render_quality\": \"高质量异想天开渲染\"\n  }\n}"
          },
          "images": {
            "thumbnail": "images/prompt/24.webp",
            "full": "images/prompt/24.webp"
          }
        }
      ]
    }
